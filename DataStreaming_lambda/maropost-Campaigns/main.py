...
def main(
    ...
    #print(api_response.data[int(previous_successful_load_response.data.item_to_start_loading_from):])
    #print(previous_successful_load_response.data.item_to_start_loading_from)
    #print(type(int(previous_successful_load_response.data.item_to_start_loading_from)))
    ...
    firehose_response = firehose_facade.load_data(
        ...
        data=api_response.data[
            int(previous_successful_load_response.data.item_to_start_loading_from) :
        ],
    )
